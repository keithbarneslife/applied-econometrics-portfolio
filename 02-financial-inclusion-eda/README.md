...
Open `02-financial-inclusion-eda/analysis.R` in Working Copy, webRios alongside. Paste file contents into webRios to reload state. Write new commands in the file, copy over to webRios to run. Commit and push at the end.
