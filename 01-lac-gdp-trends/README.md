...
Quick version:
1. Open `01-lac-gdp-trends/analysis.R` in Working Copy. This is your source of truth.
...
5. At the end of the session, commit and push from Working Copy. Suggested message: `"Project 01: [what you did this session]"`.
