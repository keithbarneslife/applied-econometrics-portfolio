...
Quick version:
1. Open `06-panel-structure/analysis.R` in Working Copy. This is your source of truth.
...
5. At the end of the session, commit and push from Working Copy. Suggested message: `"Project 06: [what you did this session]"`.
